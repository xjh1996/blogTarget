...
<body>
	<form action="<%=path %>" method="post" id="mainblog" name="mainblog">
		标题<input type="text" name="title" value="${blog.title}"/><br><br>
		类别<input type="text" name="typename" value="${blog.type.typename}" disabled="disabled"/><br><br>
		<input name="content" type="hidden" id="content">   
		<input type="button" onclick="checkInput(${blog.id})" value="提交"> 	
	</form>
